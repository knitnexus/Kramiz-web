...
export const Login: React.FC<LoginProps> = ({ onLogin, onBack }) => {
    ...
    return (
        <div className="min-h-screen bg-[#f0f2f5] flex items-center justify-center p-4 pt-[calc(16px+env(safe-area-inset-top))] pb-[calc(16px+env(safe-area-inset-bottom))]">
